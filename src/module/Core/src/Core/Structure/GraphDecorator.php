...
class GraphDecorator implements DecoratorInterface {
	...
	public function getConcreteComponent() {
		return $this->components ['concrete'];
	}
	
	/**
	 *
	 * @param ComponentInterface $concreteComponent        	
	 */
	public function setConcreteComponent(ComponentInterface $concreteComponent) {
		$this->components ['concrete'] = $concreteComponent;
		return $this;
	}
