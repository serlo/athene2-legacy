...
class RepositoryPluginControllerTest extends Athene2ApplicationTestCase
{
    ...
    public function setUp()
    {
        ...
        $controller = $this->getApplicationServiceLocator()->get('Entity\Plugin\Repository\Controller\RepositoryController');
        ...
        $this->repositoryPluginMock = $this->getMock('Entity\Plugin\Repository\RepositoryPlugin');
    ...
    public function testAddRevisionAction()
    {
        ...
        $this->repositoryPluginMock->expects($this->once())
            ...
            ->will($this->returnValue(new \Entity\Form\ArticleForm()));
