 ...
 */
namespace EntityTest\Plugin;

use Entity\Plugin\Repository\RepositoryPlugin;
...
class RepositoryPluginTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->repository->setConfig(array(
            'revision_form' => 'EntityTest\Plugin\Fake\FormFake',
            'field_order' => array(
                'foo',
                'bar'
            )
    ...
    /**
     * @expectedException \Entity\Exception\ClassNotFoundException
     */
    ...
    {
        $this->assertInstanceOf('EntityTest\Plugin\Fake\FormFake', $this->repository->getRevisionForm());
    }
