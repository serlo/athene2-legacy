...
class PhpDebugRenderer implements Renderer, TreeRendererInterface
{
    ...
    /**
     * @var ArrayAccess array or associative array representing available variables
     */
    private $__vars;
    ...
    public function render($nameOrModel, $values = null)
    {
        ...
        if (isset($model) && (! $model->getVariable('__disableTemplateDebugger', false))) {
            $this->__content = '<!-- template-identity: ' . $template . ' -->' . $this->__content;
            unset($model);
        }
