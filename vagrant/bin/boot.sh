...
sudo su - www-data -c "(cd /var/www/;COMPOSER_PROCESS_TIMEOUT=60000 php composer.phar install)"
sudo su - www-data -c "(cd /var/www/;COMPOSER_PROCESS_TIMEOUT=60000 php composer.phar update)"