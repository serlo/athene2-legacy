...
sudo indexer --all
sudo searchd
sudo su - vagrant -c "(cd /var/www/src/assets;npm cache clean)"
sudo su - vagrant -c "cd /home/vagrant/athene2-assets/;npm update"
sudo su - www-data -c "(cd /var/www/src/assets;bower cache clean)"
sudo su - www-data -c "(cd /var/www/src/assets;bower update)"
sudo su - vagrant -c "(cd /var/www/src/assets;grunt build)"
